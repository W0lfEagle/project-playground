...
$(function() {
    $('#make-call').click(function() {
        //initiate call
        var call = peer.call('Randomadfpovihq39', window.localStream);
        conn = peer.connect('Randomadfpovihq39');
        makeCall(call);
        makeConn(conn);
    });
...
//p.id = 'insert-module';
    p.innerHTML = '<a href="#" id="insert-module">Insert Module</a>';
